...
@DisplayName("QuoteRepository: findTopQuoteIds unit test suit")
class QuoteRepositoryTest_findTopQuoteIds {
    @Autowired
    ...
    void shouldReturnEmptyListIfThereAreNoQuotes() {
        final var quotes = quoteRepository.findTopQuoteIds(10);
    ...
    void shouldReturnAllExistingQuotesIfTheirCountLessThenLimit(Integer quotesCount, Integer limit) {
        ...
        final var quotes = quoteRepository.findTopQuoteIds(limit);
    ...
    void shouldReturnCorrectQuoteIds() {
        ...
        final var quotes = quoteRepository.findTopQuoteIds(3);
